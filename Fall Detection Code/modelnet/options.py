...
class Options():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--dataroot', default='/content/drive/MyDrive/our dataset (temp)', help='path to images & laser point clouds')
        self.parser.add_argument('--classes', type=int, default=4, help='ModelNet40 or ModelNet10')
